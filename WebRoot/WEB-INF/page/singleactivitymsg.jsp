...
<html>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){ 
			...
			$("#title").text("${activity.activityname}-${atime }");
			initWorker();
   					...
   					for(var i = 0; i<msgjson.length; i++) {
   						...
   						flag = true;
   				     	if(msgjson[i].type == 0) {
   				     		...
   				     		if("${currentusername}" == msgjson[i].username) {
   				     			...
   				     			contentHtml += "</div>";
   				     		} else if("${activity.leader}" == msgjson[i].username && "${currentusername}" != msgjson[i].username) {
   				     	...
   				     	if(UrNavigator.Chrome()) {
   				     		$("#scroller a").css({"max-width":"500px"});
   				     	}
	...
	<body>
		<div data-role="page">
			<div data-role="header" style="overflow:hidden;">
			    ...
			    <a onclick="showLoading();location.href='<%=basePath%>singleactivity/view?aid=${activity.id }&ret=1'" data-icon="arrow-l" class="ui-btn-left">返回</a>
